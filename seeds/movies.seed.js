...
const addMovie = async () => {
    ...
    try {
        await MovieModel.insertMany( movies ) // ? Esto es una promesa!
        // Esto es lo que ocurre despues que la promesa de arriba fue resuelta
        console.log("todo bien, las pelis se van agregando")
    }
    catch(err){
        console.log( err )
    }
